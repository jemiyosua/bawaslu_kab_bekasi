			...
			<table class="table table-hover">
				...
				<tbody>
					...
					$q = "SELECT id, kategori_capil, no_urut, nama_capil, jenis_kelamin, dapil, status FROM db_master_capil 
						WHERE kategori_capil = 'DPRD-PROV' 
			...
			<nav aria-label="Page navigation example" style="padding-top: 15px;">
				<ul class="pagination">
					...
					if ($page == 1) { // Jika page adalah page ke 1, maka disable link PREV
						...
						echo "<li class='page-item'><a class='page-link' href='master-dprd-prov.php?page=1&cari_no_urut=$ParamNoUrut&cari_nama_calon=$ParamNamaCalon&cari_jenis_kelamin=$ParamJenisKelamin&cari_status=$ParamStatus'>First</a></li>";
						echo "<li class='page-item'><a class='page-link' href='master-dprd-prov.php?page=$link_prev&cari_no_urut=$ParamNoUrut&cari_nama_calon=$ParamNamaCalon&cari_jenis_kelamin=$ParamJenisKelamin&cari_status=$ParamStatus'>&laquo;</a></li>";
					}
					...
					for ($i = $start_number; $i <= $end_number; $i++) {
						...
						echo "<li$link_active><a class='page-link' href='master-dprd-prov.php?page=$i&cari_no_urut=$ParamNoUrut&cari_nama_calon=$ParamNamaCalon&cari_jenis_kelamin=$ParamJenisKelamin&cari_status=$ParamStatus'>$i</a></li>";
					}
					...
					if ($page == $jumlah_page) { // Jika page terakhir
						...
						echo "<li class='page-item'><a class='page-link' href='master-dprd-prov.php?page=$link_next&cari_no_urut=$ParamNoUrut&cari_nama_calon=$ParamNamaCalon&cari_jenis_kelamin=$ParamJenisKelamin&cari_status=$ParamStatus'>&raquo;</a></li>";
						echo "<li class='page-item'><a class='page-link' href='master-dprd-prov.php?page=$jumlah_page&cari_no_urut=$ParamNoUrut&cari_nama_calon=$ParamNamaCalon&cari_jenis_kelamin=$ParamJenisKelamin&cari_status=$ParamStatus'>Last</a></li>";
					}

...
<main id="main" class="main">
	...
	<div class="pagetitle">
	    <!-- <h1>Form Suara <?= $KategoriCapil ?></h1> -->
	    <h1><i class="bi bi-person-raised-hand"></i> <?= $NamaCapil ?></h1>
	</div>
		...
		<div class="row">
            ...
            if ($CountIsi > 0) {
                ...
                <div class="alert alert-danger" role="alert">
                    <div style="font-weight: bold;">Anda Sudah Melakukan Pengisian Form Jumlah Suara Untuk <?= $KategoriCapil ?></div>
                </div>
                        ...
                        <form method="POST" action="proses.php" id="submit-form-suara">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" class="form-control" name="id_capil" id="id_capil" value="<?= $IdCapil ?>">
